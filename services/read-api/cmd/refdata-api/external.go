...
var externalShims = []externalShim{
	...
	},
	{
		...
		guardRelations: []string{"equipment_oee_shift", "agg_equipment_values_1min", "production_orders_runtime", "production_orders", "equipments", "sites", "areas", "packml_register"},
	},
}
