...
variable "services" {
  ...
  default = {
    ...
    dbeaver  = 8093  # CloudBeaver web DB IDE — analytics plane (read-only cloudbeaver_ro; nicer UX than pgweb)
...
variable "service_auth" {
  ...
  default = {
    ...
    dbeaver  = "csadmin" # cloudbeaver — staff-only web DB IDE (dbeaver.staging.packiot.app)
