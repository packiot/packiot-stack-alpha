...
COMMENT ON COLUMN packml_register.id_rejectcounter IS
 'DEPRECATED / DEAD (0 rows platform-wide). Only ever read by the counterroles resolver, removed 2026-08-26. Pending drop after edge-api CRUD stops selecting it.';
